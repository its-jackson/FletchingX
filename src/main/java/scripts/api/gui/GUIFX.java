...
public class GUIFX extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        stage.setTitle("Fletching X - Written By Polymorphic");

        stage.getIcons().add(new Image("https://oldschool.runescape.wiki/images/thumb/Magic_longbow_detail.png/800px-Magic_longbow_detail.png?68b64"));
